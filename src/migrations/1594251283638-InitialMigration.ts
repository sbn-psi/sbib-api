...
export class InitialMigration1594251283638 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `seqs` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255), `targetId` int NOT NULL, `use_me` tinyint, `is_useme` boolean, `is_done` boolean, PRIMARY KEY (`id`)) ENGINE=InnoDB");
