...
export class InitialMigration1594251283638 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `targets` (`id` int, `name` varchar(255), `version` varchar(255), `date` varchar(255), `fc` varchar(255), `vir` varchar(255), `note` varchar(255), `status` varchar(255), `comment` varchar(255), PRIMARY KEY (`id`)) ENGINE=InnoDB");
    }
